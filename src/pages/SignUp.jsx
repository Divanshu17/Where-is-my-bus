    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-gradient-to-b from-[#f0e6d2] to-[#d9c9a8] relative overflow-hidden">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="button"
            className="w-full py-3 border border-gray-300 text-gray-800 bg-white rounded-lg font-semibold shadow-md hover:bg-gray-50 transition-all flex items-center justify-center"
          >
