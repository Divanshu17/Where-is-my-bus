...
const API_KEY = "5b3ce3597851110001cf624824c51333a9f64c12b40c264a4665395c"
  ...
  useEffect(() => {
    ...
    const fetchRoute = async () => {
      ...
      const url = `https://api.openrouteservice.org/v2/directions/driving-car?api_key=${process.env.API_KEY}&start=${START_COORDS[1]},${START_COORDS[0]}&end=${destination[1]},${destination[0]}&intermediate=${waypoints}`;
...
//           <ArrowLeftIcon className="h-6 w-6 text-gray-600" />
//         </button>
//         <h2 className="text-xl font-semibold text-gray-900">Bus Route Map</h2>
//         <div className="w-10 h-10 bg-white rounded-full shadow-md"></div>
//       </div>
...
//           type="text"
//           placeholder="Search location..."
//           className="w-full pl-12 pr-4 py-3 bg-white rounded-full shadow-md focus:ring-2 focus:ring-blue-500"
//         />
//       </div>
...
//             exit={{ opacity: 0, y: 10 }}
//             transition={{ duration: 0.3 }}
//             className="w-full max-w-md bg-white shadow-lg rounded-xl px-6 py-3 text-center"
//           >
//             <h3 className="text-lg font-semibold text-gray-900">{notification.name}</h3>
